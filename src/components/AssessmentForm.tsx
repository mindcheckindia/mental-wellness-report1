            ...
            case 0: // Welcome
                return (
                    <FormCard className="text-center">
                        ...
                        <p className="text-lg text-slate-300 max-w-3xl mx-auto mb-4">Our methodology is grounded in established clinical frameworks, including the <span className="text-slate-100 font-medium">DSM-5 criteria</span> and <span className="text-slate-100 font-medium">PROMIS® scales</span>, which are widely considered the gold standard in mental health evaluation.</p>
