                ...
                return (
                    <FormCard className="max-w-4xl">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-lg text-slate-300 max-w-3xl mb-4">This isn't just another generic mental health assessment. It's a scientifically-designed, dynamic assessment that <span className="text-slate-100 font-medium">adapts in real-time</span> to your unique well-being needs.</p>
                            <p className="text-lg text-slate-300 max-w-3xl mb-4">Our methodology is grounded in established clinical frameworks, such as the <span className="text-slate-100 font-medium">DSM-5 criteria</span> and <span className="text-slate-100 font-medium">PROMIS® scales</span>.</p>
                            ...
                            <p className="text-lg text-slate-300 max-w-3xl mb-8">Your privacy is our top priority. All data you provide is <span className="text-sky-300 font-semibold">encrypted</span> and handled with the highest privacy standards to ensure your information remains secure and confidential.</p>
